...
class Isa(Enum):
    ...
    MVVCW = "MVVCW", "Move Vertical Clockwise", "Starting in HH position, rotate left gripper counterclockwise and right gripper clockwise, then reset to HH position."
    MVVCCW = "MVVCCW", "Move Vertical Counterclockwise", "Starting in HH position, rotate left gripper clockwise and right gripper counterclockwise, then reset to HH position."
    MVHCW = "MVHCW", "Move Horizontal Clockwise", "Starting in HV position, rotate top gripper clockwise and bottom gripper counterclockwise, then reset to HV position."
    MVHCCW = "MVHCCW", "Move Horizontal Counterclockwise", "Starting in HV position, rotate top gripper counterclockwise and bottom gripper clockwise, then reset to HV position."
    ...
    RRC = "RRC", "Rotate Right Clockwise", "Starting in ST position, rotate right gripper clockwise, then reset to ST position."
    RRCCW = "RRCCW", "Rotate Right Counterclockwise", "Starting in ST position, rotate right gripper counterclockwise, then reset to ST position."
